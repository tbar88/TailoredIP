<!-- TODO: Copy this file into the organization-level .github repository at .github/copilot-instructions.md so the same standing instructions apply across all repos. -->
